...
public class Vehicle {
	...
	// Atributs
		...
		protected ArrayList<Persona> conductors;

		
		// Constructors
		
		public Vehicle(String matricula, String marca, String color, Persona titular, ArrayList<Persona> conductors) {
			...
			for (int i = 1; i < conductors.size(); i++) {
				this.conductors.add(conductors.get(i));
			}
